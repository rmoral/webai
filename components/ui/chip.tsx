...
export function Chip({
  ...
  return (
    <button
      ...
      className={cn(
        // 32px is the design-system height; below md it grows to a target
        // a thumb actually hits.
        "inline-flex h-11 shrink-0 items-center md:h-8",
        "justify-center rounded-md border px-3 text-sm font-medium whitespace-nowrap transition-colors outline-none",
